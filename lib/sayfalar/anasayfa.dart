...
import 'package:sanal_ev_kutuphanesi/sayfalar/kitap_bilgileri.dart';
import 'package:sanal_ev_kutuphanesi/sayfalar/kitap_ekleme.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: aramaYap
            ? TextField(
          decoration: const InputDecoration(hintText: "Kitap adını giriniz."),
                          ...
                          IconButton(
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text("${kitap.kitap_adi} silinsin mi?"),
                                  action: SnackBarAction(
                                    label: "EVET",
                                    onPressed: () {
                                      context.read<AnasayfaCubit>().sil(kitap.kitap_id);
                                    },
                                  ),
                                ),
                              );
