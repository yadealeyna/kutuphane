...
class _KitapBilgileriState extends State<KitapBilgileri> {
  ...
  Future<void> kitap(String kitap_adi, String yazar_adi,String cevirmen_adi, String tur, String baski_no, String alinma_tarihi, String okunma_tarihi, String yorum) async {
    print("Kitap: $kitap_adi - $yazar_adi - $cevirmen_adi - $tur - $baski_no - $alinma_tarihi - $okunma_tarihi - $yorum");
  }
  @override
    ...
    child: Padding(
      ...
      children: [
        ...
        ElevatedButton(onPressed: (){
          context..read<KitapBilgiCubit>().kguncelle(widget.kitap.kitap_id, tfKitapAd.text,tfYazarAd.text, tfCevirmenAd.text, tfTur.text , tfBaskiNo.text, tfAlinmaTarihi.text, tfOkunmaTarihi.text, tfYorum.text);
          },
